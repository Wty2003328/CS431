...
ioExpanderAInterruptHandler()
{
	...
	if (task_handle_io_expander_a_interrupt_service_) {
...
ioExpanderBInterruptHandler()
{
	...
	if (task_handle_io_expander_b_interrupt_service_) {
...
timerInterruptHandler(void* arg)
{
    ...
    interval_real_time_task_ = current_real_time - time_point_start;
    time_point_start = current_real_time;
