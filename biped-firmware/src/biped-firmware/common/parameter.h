...
//constexpr char ip_ground_station[] = "192.168.1.255";   //!< Biped ground station IP address.
constexpr char ip_ground_station[] = "192.168.1.43";   //!< Biped ground station IP address.
